...
public class Assignment4 {
	...
	@Test(priority=5,dataProvider ="getModifiedData" )
	static void modifyCustomer(String name)
	{
		try
		{
			...
			oBrowser.findElement(By.xpath("//*[@id=\"taskListBlock\"]/div[2]/div[1]/div[3]/div/div[2]/input")).sendKeys(name);
			Thread.sleep(2000);
